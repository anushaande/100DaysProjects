...
colors = ['red', 'blue', 'green', 'cyan', 'yellow', 'pink', 'purple', 'magenta', 'white', 'orange']
turtle_list = []
y = 260.00
x = -450.00
...
if user_bet == winning_turtle_color[0]:
    print(f"Congratulations!! You wont the bet.{winning_turtle_color[0].upper()} turtle won the race")
else:
    print(f"Sorry! You lost the bet.{winning_turtle_color[0].upper()} turtle won the race")
